...
CREATE TABLE IF NOT EXISTS `TB_USUARIO` (
  ...
  `US_NIVEL` VARCHAR(5) NOT NULL DEFAULT 'USER',
  PRIMARY KEY (`US_NOME`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `TB_LAMPADA` (
  ...
  `LP_SENSOR` BOOLEAN NULL DEFAULT 0,
  `LP_PORTASEN` INT NOT NULL DEFAULT 0,
...
-- INSERT'S 
-- USUARIO
INSERT INTO `fenrir`.`tb_usuario` (`us_nome`, `us_senha`) VALUES ('maycon', '202cb962ac59075b964b07152d234b70', 'ADMIN'); -- senha 123
INSERT INTO `fenrir`.`tb_usuario` (`us_nome`, `us_senha`) VALUES ('caio', '202cb962ac59075b964b07152d234b70', 'ADMIN'); -- senha 123
